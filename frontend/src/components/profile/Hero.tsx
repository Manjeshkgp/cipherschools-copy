...
const Hero = () => {
  ...
  <div
        ...
        className="flex w-full h-[90px] border-b text-gray-800 dark:text-gray-50 border-gray-200 relative bg-gray-50 dark:bg-gray-800"
      >
        ...
        <div className="grid place-items-center">
          <p className="mr-8">0 Followers</p>
        </div>
        </div>
      </div>
  </>)
